...
MongoDatabank.prototype.connect = function(params, onCompletion) {
    ...
    var host = params.host || this.host,
        ...
        doConnect = function(err, dbname) {

            bank.db = new Db(dbname, server);
            bank.dbname = dbname;
    ...
    if (bank.mktmp) {
        randomString(8, doConnect); 
    } else {
        doConnect(null, bank.dbname);
    }
};
